...
public class renew extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbxRenew = new javax.swing.JComboBox<>();
        jLabel13 = new javax.swing.JLabel();
        lblRenew = new javax.swing.JLabel();
        ...
        SectionTitle.setText("Renew Section");
        ...
        cbxRenew.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2 Days", "3 Days" }));

        jLabel13.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel13.setText("New Due Date");

        lblRenew.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblRenew.setForeground(new java.awt.Color(204, 0, 0));
        lblRenew.setText("- - - - - - - - - - - -");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(lblToday, javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(cbxRenew, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE))))))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel10)
                            .addComponent(cbxRenew, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel13)
                            .addComponent(lblRenew))))
            ...
            while (inputFile.hasNext()) {       // Read lines from the file until no more are left.
                ...
                String borrowstatus = details[8];
                    ...
                    LocalDate DueDate = LocalDate.parse(lblDueDate.getText());
                        ...
                        JOptionPane.showMessageDialog(this, "Oops! Due Date has passed! Renew Is Impossible!");
                        status = "rejected";
                        setReset();
                        }
                        else if (currentDate.isBefore(DueDate) && cbxRenew.getSelectedItem().toString() == "2 Days") {
                            DueDate = DueDate.plus(2, ChronoUnit.DAYS);
                            lblRenew.setText(DueDate.toString());
                            status = "success";
                            }
                       else  if (currentDate.isBefore(DueDate) && cbxRenew.getSelectedItem().toString() == "3 Days") {
                                DueDate = DueDate.plus(3, ChronoUnit.DAYS);
                                lblRenew.setText(DueDate.toString());
                                status = "success";
                                }
    ...
    private void ConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmActionPerformed
        ...
        RenewDate = lblRenew.getText();
        String oldContent = "";
        String status = "fail";
               if (CNAME.equals("- - - - - - - - - - - -")){
               JOptionPane.showMessageDialog(this, "Incomplete Data Entry!!");
               }
        else {result = JOptionPane.showConfirmDialog(this, "Are You Sure You Want To Renew This Book?", "Save To Library", JOptionPane.ERROR_MESSAGE);
        ...
        {   
            ...
            String[] details = line.split(":");
                ...
                String newString = details[0] + ":" + details[1] + ":" + details[2] + ":" + details[3] + ":" + details[4] + ":" + details[5] + ":" + details[6] + ":" + RenewDate + ":" + details[8];
                ...
                writer.flush();
                status = "success";
                JOptionPane.showMessageDialog(this, "Renew Successful!");
                setReset();
                }
             }
                if (status=="fail"){
    ...
    private javax.swing.JComboBox<String> cbxRenew;
    ...
    private javax.swing.JLabel lblRenew;
    private javax.swing.JLabel lblToday;
    // End of variables declaration//GEN-END:variables
    private String CID, BN, RenewDate, CNAME;
    private int result;
}
